...
export async function getCustomer(id,callback) {
  const URL = fetch.CUSTOMER_DETAIL_ENDPOINT + id;
  const customer = fetch.api(URL, {
        method: 'GET',
        credentials: 'include',
      },callback,true);// fetch
    ...
    /*if(customer.status == "200")  {
          ...
          console.warn('Missing results key in Customer results');
          return [];
        }// if-else*/
}// customer_detail_api
